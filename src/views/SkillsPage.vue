...
export default {
    ...
    data() {
        return {
            abilities_const: ['a Frontend Engineer', 'Data Science Enthusiast', 'Freelancer', 'Occasional Designer']
        }
    },
...
<template>
    ...
    <section class="hero is-fullheight second-page ">
        <div class="hero-body">
            <div class="container has-text-centered">
...
background: linear-gradient(270deg, rgba(255,217,237,1) 0%, rgba(40,0,255,0.8758096988795518) 100%);
}
#blank{
    height: 300px;
}
